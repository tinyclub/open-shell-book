...
\newcommand\makecover[4]{%
    \clearpage
    \begin{table}
%        \centering\includegraphics[width=\imgwidth,center]{#1}
        \centering\includegraphics[width=150pt,center]{#1}
        \centering\large{#2}
%        \centering\includegraphics[width=\imgwidth,center]{#3}
        \centering\includegraphics[width=160pt,center]{#3}
        \centering\large{#4}
    \end{table}
    \addtocounter{page}{-1}
    \newpage}
...
\newcommand{\img}[1]{\begin{figure}[h!]
	\refstepcounter{img}
	\label{img:\theimg}
	\centering\includegraphics[width=\maxwidth]{pic/\theimg.jpg}
	\caption{#1}
\end{figure}}
...
%\afterpage{\blankpage}
\makecover{<%= cover_image1 %>}{<%= cover_desc1 %>}{<%= cover_image2 %>}{<%= cover_desc2 %>}
